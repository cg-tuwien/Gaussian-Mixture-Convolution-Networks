...
mixture = gm.generate_random_mixtures(n_layers=2, n_components=2000, n_dims=3,
                                          pos_radius=40, cov_radius=1.5 / (2000**(1/3)),
...
vis.set_gaussian_mixtures(mixture, isgmm=True)
