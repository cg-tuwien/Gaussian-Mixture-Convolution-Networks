...
tensor_board_writer = torch.utils.tensorboard.SummaryWriter("../data/tensorboard/pylibtest2")
...
pc1 = pointcloud.load_pc_from_off("../vpp_modules/gm_vis/da-gm-1/da-gm-1/data/chair_0030HR.off")
pc2 = pointcloud.load_pc_from_off("../vpp_modules/gm_vis/da-gm-1/da-gm-1/data/chair_0128HR.off")
...
vis = pygmvis.create_visualizer(True, width=500, height=500)
