...
experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasYes_bnCCmean", kernel_learning_rate=0.001, learn_covariances_after=200,
...
#experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasYes_bnCCintgrl", kernel_learning_rate=0.001, learn_covariances_after=200,
                               #learn_positions_after=200, log_interval=1000, gmcn_config=gmcn_config)
...
#experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasYes_bnCCintgrl_bnLayerMean", kernel_learning_rate=0.001, learn_covariances_after=200,
                               #learn_positions_after=200, log_interval=1000, gmcn_config=gmcn_config)
...
#experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasNSP_bnCCintgrl", kernel_learning_rate=0.001, learn_covariances_after=100,
...
#experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasNSP_bnCCintgrl_bnLayerMean", kernel_learning_rate=0.001, learn_covariances_after=100,
                               #learn_positions_after=100, log_interval=1000, gmcn_config=gmcn_config)
