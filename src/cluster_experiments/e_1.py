...
experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasYes_bnCCzero", kernel_learning_rate=0.001, learn_covariances_after=200,
...
experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3_biasYes_bnCCzero_bnLayerMean", kernel_learning_rate=0.001, learn_covariances_after=200,
                               learn_positions_after=200, log_interval=1000, gmcn_config=gmcn_config)
