...
gmcn_config.mnist_n_layers_2 = 8
gmcn_config.mnist_n_out_g_2 = 10
gmcn_config.mnist_n_out_g_3 = 8

experiment_gm_mnist.experiment(device=device, n_epochs=200, desc_string="M2_k001", kernel_learning_rate=0.001, learn_covariances_after=200,
