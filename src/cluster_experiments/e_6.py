...
fitconf = pcfit.Config(n_gaussians=64, eps=0.00004, gengmm_path=tmp_gmm_base_path)
pcfit.fit(fitconf)
...
main.experiment(device=device, desc_string=f"EM64_{c.produce_description()}", config=c)
