...
//        printf("component_out_id: %d\n", component_out_id);
        ...
        out_mixture_a[int(batch_id)][int(channel_out_id)][int(component_out_id)] = gpe::Gaussian<N_DIMS, scalar_t>(data_gaussian.weight * kernel_gaussian.weight, data_gaussian.position + kernel_gaussian.position, data_gaussian.covariance + kernel_gaussian.covariance);
