...
cuda_extra_cuda_cflags = ["-O3",  "--use_fast_math", "--expt-extended-lambda", "-std=c++17", " --expt-relaxed-constexpr", "-DGPE_LIMIT_N_REDUCTION"]  # , "-DNDEBUG"
if platform.system() == "Windows":
    ...
    cuda_extra_cflags = ["-O3", "-ffast-math", "-march=native", "-std=c++17", "-DGPE_LIMIT_N_REDUCTION"]
