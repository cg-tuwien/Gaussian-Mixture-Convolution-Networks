...
//    };
//    std::vector<bvh_mhem_fit_alpha::Config::FitInitialDisparityMethod> fit_initial_disparity_options = {
//        bvh_mhem_fit_alpha::Config::FitInitialDisparityMethod::CentroidDistance,
//        bvh_mhem_fit_alpha::Config::FitInitialDisparityMethod::Likelihood,
//        bvh_mhem_fit_alpha::Config::FitInitialDisparityMethod::KLDivergence
//    };
//    std::vector<bvh_mhem_fit_alpha::Config::FitInitialClusterMergeMethod> fit_initial_cluster_merge_options = {
//        bvh_mhem_fit_alpha::Config::FitInitialClusterMergeMethod::Average,
//        bvh_mhem_fit_alpha::Config::FitInitialClusterMergeMethod::AverageCorrected,
//        bvh_mhem_fit_alpha::Config::FitInitialClusterMergeMethod::MaxWeight,
//        bvh_mhem_fit_alpha::Config::FitInitialClusterMergeMethod::MaxIntegral
//    };
//    std::vector<float> em_kl_div_threshold_options {0.5, 1.0f, 1.5f, 2.0f, 2.5f};
    ...
    std::vector<std::pair<std::string, bvh_mhem_fit_alpha::Config>> configs;
...
//                                             bvh_mhem_fit_alpha::Config{reduction_n, lbvh::Config{morton_code_algorithm}, fit_initial_disparity_method, fit_initial_cluster_merge_method, em_kl_div_threshold});
                        configs.emplace_back(std::to_string(reduction_n) +
                                             ...
                                             bvh_mhem_fit_alpha::Config{reduction_n, lbvh::Config{morton_code_algorithm}, fit_initial_disparity_method, fit_initial_cluster_merge_method, em_kl_div_threshold, N_FITTING_COMPONENTS});
...
//                auto t1 = std::chrono::high_resolution_clock::now();
                ...
                if (BACKWARD) {
                    ...
                    for (int i = 0; i < 100; ++i) {
                        ...
                        auto forward_out = bvh_mhem_fit_alpha::forward_impl(mixture_copy, named_config.second);
...
//                        auto gradient_fitting = forward_out.fitting.cpu() - target;
                        ...
                        auto gradient_target = bvh_mhem_fit_alpha::backward_impl(gradient_fitting, forward_out, named_config.second);
...
//                    assert((gpe::weights(gradient_target) <= 0).all().item<bool>());
                ...
                auto forward_out = bvh_mhem_fit_alpha::forward_impl(mixture, named_config.second);
                cudaDeviceSynchronize();
