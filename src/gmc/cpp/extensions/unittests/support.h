...
inline
std::vector<torch::Tensor> _collectionOf2d32GsGrads () {
    std::vector<torch::Tensor> grads;
    grads.emplace_back(torch::tensor({{1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f},
                                      {1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f},
                                      {1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f},
                                      ...
                                      {1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f},
                                      {1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f},
                                      {1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f,  1.0f}}).view({1, 1, 32, 7}));

    grads.emplace_back(torch::tensor({{-1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f},
                                      ...
                                      {-1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f},
                                      {-1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f},
                                      {-1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f,  -1.3f}}).view({1, 1, 32, 7}));
