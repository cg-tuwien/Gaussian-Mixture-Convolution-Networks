...
#     EckartGeneratorSP(n_gaussians_per_node=8, n_levels=3, termination_criterion=terminator2, initialization_method='bb', partition_treshold=0.1, m_step_points_subbatchsize=10000, e_step_pair_subbatchsize=5120000),
...
generators = [
    # EMGenerator(n_gaussians=n_gaussians, initialization_method='randnormpos', n_sample_points=10000,
    #              termination_criterion=terminator2),
    EckartGeneratorHP(n_gaussians_per_node=8, n_levels=2, termination_criterion=terminator2, initialization_method='randnormpos', m_step_points_subbatchsize=10000),
    EckartGeneratorSP(n_gaussians_per_node=8, n_levels=2, termination_criterion=terminator2, initialization_method='randnormpos', partition_treshold=0.1, m_step_points_subbatchsize=10000, e_step_pair_subbatchsize=5120000),
    EckartGeneratorHP(n_gaussians_per_node=8, n_levels=3, termination_criterion=terminator2, initialization_method='randnormpos', m_step_points_subbatchsize=10000),
    EckartGeneratorSP(n_gaussians_per_node=8, n_levels=3, termination_criterion=terminator2, initialization_method='randnormpos', partition_treshold=0.1, m_step_points_subbatchsize=10000, e_step_pair_subbatchsize=5120000),
]
generator_identifiers = ["L2-1-HP", "L2-2-SP0.1", "L3-1-HP", "L3-2-SP0.1"]

# generators = [
#     EckartGeneratorHP(n_gaussians_per_node=8, n_levels=3, termination_criterion=terminator2, initialization_method='eigen', m_step_points_subbatchsize=10000)
# ]
# generator_identifiers = ["14-EckHPiEigen"]
