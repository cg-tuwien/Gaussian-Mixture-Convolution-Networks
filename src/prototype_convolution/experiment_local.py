...
experiment_gm_mnist.experiment(device=device, n_epochs=100, desc_string="M3pp_BNbeforeReLU_biasNo_bnCCzero_rndFitting_detachedInitM_fixed_klthr1.5", kernel_learning_rate=0.001, learn_covariances_after=100,
