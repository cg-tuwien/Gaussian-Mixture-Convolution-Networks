...
class LcSmoothness(EvalFunction):
    # Calculates the smoothness according to the locally consistent gmm paper
    # Not used for our thesis and apparently not useful.
    # But smoothness.py is based on a similar idea.
    ...
    def get_names(self) -> List[str]:
        nlst = []
        nlst.append("LcSmoothness (Unscaled)")
        return nlst
