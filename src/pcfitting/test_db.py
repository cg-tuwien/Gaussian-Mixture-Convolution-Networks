...
run = access.insert_run("modelfile", 100000, 1000000, 512, 511, "EM", em, 1.24)
print("Run: ", run)
...
print ("Has EM1?", access.has_em_run("modelfile", 100000, 1000000, 512, 100000, "MaxIter(200)", "fpsmax", "float32", 1e-7, True))
print ("Has EM2?", access.has_em_run("modelfileXXX", 100000, 1000000, 64, 100000, "MaxIter(200)", "fpsmax", "float32", 1e-7, True))