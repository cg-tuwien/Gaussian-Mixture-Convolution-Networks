...
fitting_name = "EMrnp64"
pcfit.run(fitting_name,
          EMGenerator(n_gaussians=64, initialization_method="randnormpos", termination_criterion=RelChangeTerminationCriterion(0.1, 20), em_step_points_subbatchsize=10000),
