...
c.model.relu_config.fitting_method = fitting.fixed_point_and_mhem
...
c.model.layers = [Layer(8, 2.5, 32),
                  ...
                  Layer(32, 2.5, 8),
                  Layer(10, 2.5, -1)]
main.experiment(device=device, desc_string=f"mem_{fitconf.name}_{c.produce_description()}", config=c, ablation_name="fitting_quality")
