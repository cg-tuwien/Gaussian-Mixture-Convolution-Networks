...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/madam/temp/FashionMNIST', train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.FashionMNIST('/home/madam/temp/FashionMNIST', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ])),
